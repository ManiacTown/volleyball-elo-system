...
#
# VERSION 1.0.2, 1/31/2025, Avery Miclea
...
def create_match():
    ...
    #    
    #for name, elo in player_elo: # CHANGE FOR LATER
    ...
    # Step 5: Return the teams
    #print(f"Team 1: {team1}, Total ELO: {team1_elo}")
    #print(f"Team 2: {team2}, Total ELO: {team2_elo}")
    #return team1, team2
